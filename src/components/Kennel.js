...
const Kennel = () => {
  ...
  const [hasUserFromState, setHasUser] = useState(isAuthenticated());
  ...
  return (
    <>
      <NavBar hasUser={hasUserFromState} clearUser={clearUser} setUser={setUser}/>
      <ApplicationViews hasUser={hasUserFromState} setUser={setUser} />
    </>
  );
};
